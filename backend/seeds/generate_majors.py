...
MAJOR_CATALOG = {
    "工学": {
        "计算机类": [
            ...
            "区块链工程", "虚拟现实技术", "密码科学与技术",
        ],
        "电子信息类": [
            "电子信息工程", "通信工程", "微电子科学与工程", "光电信息科学与工程",
            "信息工程", "集成电路设计与集成系统", "电磁场与无线技术", "电子信息科学与技术",
            "人工智能", "柔性电子学", "智能测控工程",
        ],
        "电气类": [
        ...
        "材料类": [
            ...
            "复合材料与工程", "新能源材料与器件", "功能材料", "纳米材料与技术",
        ],
        "能源动力类": [
            "能源与动力工程", "新能源科学与工程", "储能科学与工程",
            "能源与环境系统工程", "氢能科学与工程", "可持续能源",
        ],
        "航空航天类": [
        ...
        "交通运输类": [
            "交通运输", "交通工程", "航海技术", "轮机工程",
            "飞行技术", "交通设备与控制工程", "救助与打捞工程",
            "船舶电子电气工程", "轨道交通电气与控制", "智能运输工程",
        ],
        "环境科学与工程类": [
    ...
    "医学": {
        "临床医学类": [
            "临床医学", "麻醉学", "医学影像学", "眼视光医学", "精神医学",
            "放射医学", "儿科学",
        ],
        "口腔医学类": ["口腔医学"],
        "公共卫生与预防医学类": [
            "预防医学", "食品卫生与营养学", "卫生监督", "全球健康学",
        ],
        "中医学类": [
            "中医学", "针灸推拿学", "藏医学", "维医学", "壮医学", "哈医学",
    ...
    "管理学": {
        ...
        "工商管理类": [
            ...
            "人力资源管理", "审计学", "资产评估", "物业管理",
            "文化产业管理", "体育经济与管理", "财务会计教育",
            "市场营销教育", "零售业管理", "创业管理",
        ],
        "农业经济管理类": [
            "农林经济管理", "农村区域发展",
...
def generate_employment_data(category: str, sub_category: str, name: str) -> dict:
    ...
    # 热门专业薪资加成
    hot_keywords = {
        "人工智能": 1.4, "大数据": 1.3, "计算机": 1.3, "软件": 1.25,
        "金融": 1.2, "信息安全": 1.2, "数据科学": 1.3, "集成电路": 1.3,
        "临床医学": 1.15, "口腔医学": 1.2, "电气工程": 1.15,
    }
